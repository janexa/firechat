...
firebase.initializeApp({
  apiKey: "AIzaSyDegc1NvMMqqMovndV8jY8-CVsJjjE84EM",
  authDomain: "react-firechat-b498d.firebaseapp.com",
  projectId: "react-firechat-b498d",
  storageBucket: "react-firechat-b498d.appspot.com",
  messagingSenderId: "230257536134",
  appId: "1:230257536134:web:0250a9e184c9afbd247507"
});
...
function App() {
  ...
  const renderContent = () => {
    ...
    return (
      <div className="flex items-center justify-center h-full shadow-md">
        <div className="flex flex-col items-center justify-center w-full max-w-xl p-8 mx-4 transition-all bg-white rounded-md shadow-card dark:bg-coolDark-600">
          <h2 className="flex items-center mb-2 text-3xl">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
          ...
          <p className="mb-8 text-lg text-center">
            La forma más sencilla de charlar con personas de todo el mundo.
          </p>
          <button
            onClick={signInWithGoogle}
            className="flex items-center justify-center py-3 pl-6 pr-8 overflow-y-hidden font-medium text-gray-600 bg-white rounded shadow-button hover:bg-gray-50 focus:outline-none focus:ring focus:ring-primary-500 focus:ring-opacity-75"
          >
            <svg
              viewBox="5 -5 30 30"
  ...
  return (
    <div className="flex flex-col h-full transition-colors bg-white dark:bg-coolDark-500 dark:text-white">
      <header
        className="flex items-center justify-between flex-shrink-0 px-4 shadow-md sm:px-8"
        style={{ height: 'var(--topbar-height)' }}
      >
        <a href="https://youthful-torvalds-33d4b8.netlify.app/">
        ...
        <div className="flex items-center">
          {user ? (
            <button
              onClick={signOut}
              className="px-4 py-2 mr-4 text-sm font-medium tracking-wide uppercase transition-all bg-transparent rounded text-primary-500 hover:text-white hover:bg-primary-500 focus:outline-none focus:ring focus:ring-primary-500 focus:ring-opacity-75"
            >
              Cerrar sesión
            </button>
          ) : null}
